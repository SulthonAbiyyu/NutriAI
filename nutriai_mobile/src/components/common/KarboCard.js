...
export default function KarboCard({ current = 0, target = 300, size = 220 }) {
  ...
  const buildVeins = () => {
    ...
    for (let i = 1; i <= COUNT; i++) {
      ...
      const tipX =
        ACX + PROG_R * Math.cos(arcAngle) + ARROW_LEN * 0.4 * Math.cos(tangent);
      const tipY =
        ACY + PROG_R * Math.sin(arcAngle) + ARROW_LEN * 0.4 * Math.sin(tangent);
    ...
    >
      <Svg width={SVG_SZ} height={SVG_SZ} style={StyleSheet.absoluteFill}>
        ...
        <Circle
          ...
          fill="none"
          stroke="#FFFFFF"
          strokeWidth={WHITE_STK}
        />

        {}
        {[
          { o: 0.14, rOff: 0.0, w: 0.08 },
          { o: 0.11, rOff: 0.08, w: 0.09 },
          { o: 0.09, rOff: 0.16, w: 0.1 },
          { o: 0.07, rOff: 0.24, w: 0.1 },
          { o: 0.055, rOff: 0.32, w: 0.11 },
          { o: 0.042, rOff: 0.4, w: 0.11 },
          { o: 0.03, rOff: 0.48, w: 0.12 },
          { o: 0.02, rOff: 0.56, w: 0.12 },
          { o: 0.013, rOff: 0.64, w: 0.13 },
          { o: 0.008, rOff: 0.72, w: 0.13 },
          { o: 0.004, rOff: 0.8, w: 0.14 },
        ...
        <>
          <Circle
            ...
            r={PROG_R}
            stroke="url(#progGrad)"
            strokeWidth={PROG_STK}
            fill="none"
            strokeDasharray={`${dashLen} ${CIR - dashLen}`}
            strokeDashoffset={CIR * 0.25}
            strokeLinecap="round"
          />
