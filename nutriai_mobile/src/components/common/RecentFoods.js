...
export default function RecentFoods({ recentFoods = [], onAddToCart }) {
  // Porsi per item: { [id]: number }
  const [porsiMap, setPorsiMap] = useState({});
  // Feedback "ditambahkan": { [id]: bool }
  ...
  const handleAdd = useCallback((food) => {
    ...
    // Flash feedback hijau sebentar
    setAddedMap(prev => ({ ...prev, [food.id]: true }));
    setTimeout(() => setAddedMap(prev => ({ ...prev, [food.id]: false })), 900);
    // Reset porsi setelah tambah
    ...
    <View style={styles.recentSection}>
      ...
      {recentFoods.length === 0 ? (
        ...
        <View style={styles.emptyBox}>
          ...
          <Text style={styles.emptyText}>Belum ada riwayat makanan.{'\n'}Tambah makanan pertamamu!</Text>
        </View>
      ) : (
        /* ── Chip list ── */
        <ScrollView
            ...
            return (
              ...
              >
                ...
                <View style={styles.porsiRow}>
                  ...
                  >
                    <Text style={[styles.porsiBtnTxt, porsi <= 1 && styles.porsiBtnTxtOff]}>−</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    hitSlop={{ top: 6, bottom: 6, left: 6, right: 6 }}
                  >
                    <Text style={[styles.porsiBtnTxt, porsi >= 10 && styles.porsiBtnTxtOff]}>+</Text>
                  </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.75}
                >
                  <Text style={styles.addBtnTxt}>{added ? '✓' : '+ Tambah'}</Text>
                </TouchableOpacity>
              </View>
            );
          })}
